package com.lsk.hbase2.ddl;

import com.lsk.hbase2.HBaseConnectMultThread;
...
public class HBaseDDL {
    ...
    public static Connection connection = HBaseConnectMultThread.connection;
     ...
     * @param version      版本
     */
    public static void modifyTable(String namespace, String tableName,
                                   String columnFamily, int version) throws IOException {
        // 判断表格是否存在
        if (!isTableExists(namespace, tableName)) {
